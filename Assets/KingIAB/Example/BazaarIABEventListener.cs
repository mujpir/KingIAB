...
public class BazaarIABEventListener : MonoBehaviour
{
	...
	void queryInventorySucceededEvent(List<Purchase> purchases, List<SkuInfo> skus)
	{
    ...
    private void querySkuDetailsSucceededEvent(List<SkuInfo> skus)
    {
    ...
    private void queryPurchasesSucceededEvent(List<Purchase> purchases)
    {
